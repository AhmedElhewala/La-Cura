...
window.onscroll = function() {
    ...
    if (window.scrollY >= mainSection.offsetTop - 300) {
        mainSection.classList.add("reached");
    } else {
        mainSection.classList.remove("reached");
    }
    if (window.scrollY >= emerencyHead.offsetTop - 300) {
        emerencyHead.classList.add("reached");
    } else {
        emerencyHead.classList.remove("reached");
    }
    if (window.scrollY >= emerencyCont.offsetTop - 300) {
        emerencyCont.classList.add("reached");
    } else {
        emerencyCont.classList.remove("reached");
    }
    if (window.scrollY >= healthHead.offsetTop - 300) {
        healthHead.classList.add("reached");
    } else {
        healthHead.classList.remove("reached");
    }
    if (window.scrollY >= healthNote.offsetTop - 300) {
        healthNote.classList.add("reached");
    } else {
        healthNote.classList.remove("reached");
    }
    if (window.scrollY >= careHead.offsetTop - 300) {
        careHead.classList.add("reached");
    } else {
        careHead.classList.remove("reached");
    }
    if (window.scrollY >= careCont.offsetTop - 300) {
        careBoxOne.classList.add("reached");
        careBoxTwo.classList.add("reached");
    } else {
        careBoxOne.classList.remove("reached");
        careBoxTwo.classList.remove("reached");
    }
    if (window.scrollY >= careCont.offsetTop - 150) {
        careBoxThree.classList.add("reached");
        careBoxFour.classList.add("reached");
    } else {
        careBoxThree.classList.remove("reached");
        careBoxFour.classList.remove("reached");
    }
    if (window.scrollY >= vetHead.offsetTop - 300) {
        vetHead.classList.add("reached");
    } else {
        vetHead.classList.remove("reached");
    }
    if (window.scrollY >= vetCont.offsetTop - 300) {
        vetCont.classList.add("reached");
    } else {
        vetCont.classList.remove("reached");
    }
    if (window.scrollY >= aboutHead.offsetTop - 300) {
        aboutHead.classList.add("reached");
    } else {
        aboutHead.classList.remove("reached");
    }
    if (window.scrollY >= aboutCont.offsetTop - 300) {
        aboutData.classList.add("reached");
        aboutForm.classList.add("reached");
    } else {
        aboutData.classList.remove("reached");
        aboutForm.classList.remove("reached");
    }
};
